...
def left_arm_raise():
    return ArmPositions(hand=0, joint=0, arm=0, shoulder=1100)


def right_arm_raise():
    return ArmPositions(hand=0, joint=0, arm=0, shoulder=3000)


def left_arm_down():
    return ArmPositions(hand=0, joint=0, arm=0, shoulder=2700)


def right_arm_down():
    return ArmPositions(hand=0, joint=0, arm=0, shoulder=1300)


def left_arm_open():
    return ArmPositions(hand=0, joint=0, arm=1900, shoulder=1900)
...
def left_arm_hover():
    return ArmPositions(hand=0, joint=0, arm=0, shoulder=1900)


def right_arm_hover():
    return ArmPositions(hand=0, joint=0, arm=0, shoulder=2150)
